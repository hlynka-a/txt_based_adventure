...
int main()
{
	...
	while(gameState != -1)
	{
		...
		{
			cout << "\n";
			cout << "This is an example text-based game! \n";
			cout << "MAIN MENU: What do you want to do? \n";
			cout << "1. Play New Game \n" << "2. Continue Last Saved Game \n" << "3. Quit Game \n";
			cin.sync();
			...
			if (currentChoice == 1)
				...
				cout << "I'm sorry, there is no save file functionality added yet.\n";
			else if (currentChoice == 3)
				gameState = -1;
			else
				cout << "That's not a valid choice, you silly person. \n";
...
int readInputChoice()
{
	...
	{
		cout << "Enter a proper integer, damn it! \n";
		currentChoice = 0;
	}
